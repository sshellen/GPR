  ...
  [7],
  {
      ...
      (function (n) {
        ...
        var z = (function (n) {
          ...
          j = (function (e) {
            ...
            var t = I(i);
            function i() {
              return E(this, i), t.apply(this, arguments);
            }
            return (
              b(i, [
                {
    ...
    536: function (n, e, t) {
      ...
      (function (n) {
        ...
        e.a = function (e) {
          var t = e.artist,
            A = m(Object(i.useState)(!1), 2),
            l = A[0],
            f = A[1],
            d = t && t.description ? t.description.substr(0, 100) + " ..." : "";
          return o.a.createElement(
            ...
            o.a.createElement(
              ...
              o.a.createElement(
                ...
                o.a.createElement("p", { className: "teaser" }, d),
                o.a.createElement(
                  "button",
                  {
          ...
          var E = (function (e) {
            ...
            function C(e) {
              ...
              return (
                ...
                x(g((t = f.call(this, e))), "filter", function () {
                  var e = t.state.genres,
                    i = [],
                    o = {},
                    a = {};
                  for (var r in e)
                    if (!0 === e[r]) {
                      var A = {},
                        l = {};
                      (l.$eq = r), (A.genre = l), i.push(A);
                    }
                  (o.$or = i), (a.filters = o);
                  var c = s.a.stringify(a);
                  t.fetchData(
                    ""
              ...
              (i = [
                {
                  ...
                  value: function () {
                    var e = this;
                    this.fetchData(
                      "".concat(n.env.API_URL, "/api/artists?populate=*")
                    )
                      .then(function (n) {
                        return n.json();
                      })
